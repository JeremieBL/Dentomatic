...
int main( void )
{
	...
	GLuint programR2T_ID = LoadShaders( "StandardShadingRTT.vertexshader", "StandardShadingRTT.fragmentshader" );

	// Get a handle for our "MVP" uniform
	GLuint MatrixR2T_ID = glGetUniformLocation(programR2T_ID, "MVP");
	GLuint ViewMatrixR2T_ID = glGetUniformLocation(programR2T_ID, "V");
	GLuint ModelMatrixR2T_ID = glGetUniformLocation(programR2T_ID, "M");

	// Load the texture
	GLuint TextureR2T = loadDDS("uvmap.DDS");
	
	// Get a handle for our "myTextureSampler" uniform
	GLuint TextureR2T_ID  = glGetUniformLocation(programR2T_ID, "myTextureSampler");
	...
	GLuint LightID = glGetUniformLocation(programR2T_ID, "LightPosition_worldspace");

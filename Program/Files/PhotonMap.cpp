...
//*		Structure de donn�es pour le photon map.					*
...
PhotonMap::Locate( const point &pos,        // position de la surface
             ...
             entier &found,                 // nombre de photons trouv�s
             reel **dist2,                   // distance au carre entre le photon et pos ( tableau de grandeur npphoton + 1 )
             const Photon ***photonList ) const   // liste des photons trouv�s ( tableau de grandeur npphoton + 1 )
//*************************************************************
{
    NearestPhotons nph;
...
//*****************************************************************************
{
    ...
    if ( dist2 < np->dist2[0] )
    {
        // un photon a ete trouv�, on l'ajoute a la liste des candidats
        if ( np->found < np->max )
        {
 ...
 * les photons en dessous de la mediane sont plac�s dans la moiti� inf�rieure
 * et les photons au dessu de la mediane sont plac�s dans la moiti� sup�rieure
 * le critere de comparaison est l'axe pass� en parametre
 */
//******************************************
void
...
//********************************************
{
    ...
    // recursivement, balanc� la partie de droite et la partie gauche
